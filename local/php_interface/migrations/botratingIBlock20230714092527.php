...
class botratingIBlock20230714092527 extends Version
{
    protected $description = "Добавляет инфоблок \"Рейтинг нижний\"";
  ...
  'SECTION_DELETE' => 'Удалить раздел',
    ...
    public function down()
    {
        ...
        $iBlock = $helper->Iblock()->getIblockId('botrating', 'poregione');

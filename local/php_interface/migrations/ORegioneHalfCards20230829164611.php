...
class ORegioneHalfCards20230829164611 extends Version
{
    protected $description = "Добавляет инфоблок \"Два половинчатых блока\"";
  ...
  'API_CODE' => 'halfcards',
  'REST_ON' => 'N',
  'NAME' => 'Два половинчатых-блока с текстом',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  ...
  array (
    ...
    'PROPERTY_header_text_1' => 'Заголовок 1 блока',
    'PROPERTY_header_text_2' => 'Заголовок 2 блока',
    'PROPERTY_list_content_1' => 'Список контента 1 блока',
    'PROPERTY_list_content_2' => 'Список контента 2 блока',
    'PROPERTY_block_description' => 'Описание блока',
  ),
  'Анонс|edit5' => 
  array (
    'PREVIEW_PICTURE' => 'Картинка 1 блока',
    'PREVIEW_TEXT' => 'Описание 1 блока',
  ),
  'Подробно|edit6' => 
  array (
    'DETAIL_PICTURE' => 'Картинка 2 блока',
    'DETAIL_TEXT' => 'Описание 2 блока',
  ),
  'SEO|edit14' => 
  array (
  ...
  'current_view' => 'default',
    ...
    public function down()
    {
        ...
        $iBlock = $helper->Iblock()->getIblockId('halfcards', 'poregione');

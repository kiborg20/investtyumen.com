...
class topSliderIBlock20230714072713 extends Version
{
    protected $description = "Добавляет инфоблок \"Верхний слайдер\"";
  ...
  'SECTION_DELETE' => 'Удалить раздел',
    ...
    public function down()
    {
        ...
        $iBlock = $helper->Iblock()->getIblockId('topslider', 'poregione');

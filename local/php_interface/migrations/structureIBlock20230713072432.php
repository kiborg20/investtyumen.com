...
class structureIBlock20230713072432 extends Version
{
    protected $description = "Добавляет инфоблок \"Структура сайта\"";
  ...
  'SECTION_DELETE' => 'Удалить раздел',
    ...
    public function down()
    {
        ...
        $iBlock = $helper->Iblock()->getIblockId('structure', 'poregione');

...
class ContentStructure20230829164744 extends Version
{
    protected $description = "Обновляет данные инфоблока \"Структура сайта\"";
  ...
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/#SECTION_CODE#',
  ...
  array (
    ...
    public function down()
    {
        ...
        $iBlock = $helper->Iblock()->getIblockId('structure', 'content');

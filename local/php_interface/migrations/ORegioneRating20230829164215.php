...
class ORegioneRating20230829164215 extends Version
{
    protected $description = "Добавляет инфоблок \"Рейтинг\"";
  ...
  array (
    ...
    'PROPERTY_left_rating' => 'Левый рейтинг',
    'PROPERTY_desc_left' => 'Описание левого рейтинга',
    'PROPERTY_desc_right' => 'Описание правого рейтинга',
    'PROPERTY_swap' => 'Поменять местами карточки',
    'PROPERTY_right_rating' => 'Правый рейтинг',
  ),
  'Текст блока|edit5' => 
  array (
    'PREVIEW_PICTURE' => 'Картинка блока',
    'PREVIEW_TEXT' => 'Описание блока',
  ),
  'SEO|edit14' => 
  array (
  ...
  'current_view' => 'default',
    ...
    public function down()
    {
        ...
        $iBlock = $helper->Iblock()->getIblockId('rating', 'poregione');

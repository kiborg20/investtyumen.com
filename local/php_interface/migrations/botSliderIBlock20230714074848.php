...
class botSliderIBlock20230714074848 extends Version
{
    protected $description = "Добавляет инфоблок \"Нижний слайдер\"";
  ...
  'SECTION_DELETE' => 'Удалить раздел',
    ...
    public function down()
    {
        ...
        $iBlock = $helper->Iblock()->getIblockId('botslider', 'poregione');

...
class ORegioneSliders20230829164530 extends Version
{
    protected $description = "Добавляет инфоблок \"Слайдеры\"";
  ...
  'current_view' => 'default',
    ...
    public function down()
    {
        ...
        $iBlock = $helper->Iblock()->getIblockId('sliders', 'poregione');

...
class ORegioneTextblock20230829163916 extends Version
{
    protected $description = "Добавляет инфоблок \"Блок с карточкой внутри\"";
  ...
  array (
    ...
    'PROPERTY_blockheader' => 'Заголовок блока',
    'PROPERTY_cardheader' => 'Заголовок карточки',
    'PROPERTY_refurl' => 'Ссылка для перехода',
  ),
  'Блок|edit5' => 
  array (
    'PREVIEW_PICTURE' => 'Фоновая картинка',
    'PREVIEW_TEXT' => 'Описание в блоке',
  ),
  'Карточка|edit6' => 
  array (
    'DETAIL_PICTURE' => 'Фоновая картинка в карточку',
    'DETAIL_TEXT' => 'Описание карточки',
  ),
  'SEO|edit14' => 
  array (
  ...
  'current_view' => 'default',
    ...
    public function down()
    {
        ...
        $iBlock = $helper->Iblock()->getIblockId('textblock', 'poregione');

...
class referencesIBlock20230714093818 extends Version
{
    protected $description = "Добавляет инфоблок \"Рекомендации\"";
  ...
  'SECTION_DELETE' => 'Удалить раздел',
    ...
    public function down()
    {
        ...
        $iBlock = $helper->Iblock()->getIblockId('references', 'poregione');

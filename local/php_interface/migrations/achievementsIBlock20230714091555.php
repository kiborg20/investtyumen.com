...
class achievementsIBlock20230714091555 extends Version
{
    protected $description = "Добавляет инфоблок \"Достижения\"";
  ...
  'SECTION_DELETE' => 'Удалить раздел',
    ...
    public function down()
    {
        ...
        $iBlock = $helper->Iblock()->getIblockId('achievements', 'poregione');

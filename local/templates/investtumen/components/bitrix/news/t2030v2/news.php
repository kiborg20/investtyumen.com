...
<section class="t2030trends bgblue" style="posiiton:relative; z-index:2;">
    <div class="container">
        <?php
            ...
            $APPLICATION->IncludeComponent("bitrix:catalog.section.list", "tyumen2030", Array(
...
<div id="particles-js" >
    <div class="2030bridge1" style="background: url(/images/2030/1.svg) no-repeat; background-size:110%; top: 100px; width:100%; position:fixed; height:100vh;"></div>
    <div class="2030bridge2" style="background: url(/images/2030/2.svg) no-repeat; background-size:110%; top: 100px; width:100%; position:fixed; height:100vh;"></div>
    <div class="2030bridge3" style="background: url(/images/2030/3.svg) no-repeat; background-size:110%; top: 100px; width:100%; position:fixed; height:100vh;"></div>
    <div class="2030bridge4" style="background: url(/images/2030/4.svg) no-repeat; background-size:110%; top: 100px; width:100%; position:fixed; height:100vh;"></div>
    
</div>
<section style="position:relative; z-index:2;" class="t2030trends bgblue">
    <div class="container">
        <p class="t1920 ttu">Глобальные мегатренды</p>
        <div class="trendswrapper bgblue">
    ...
    <div class="bgcardsv3 bgblue" style="background: url('/images/2030/bg.jpg') no-repeat; background-position: center bottom; background-size: cover;">
        <div class="container">
            <div class="dadflex">
                <div class="cardv3">
...
<section class="bgblue" style="position: relative; overflow: hidden;">
    <div class="container ">
        <div class="t2030contt" style="margin-top:0px;">
            ...
            <div class="textsubtitle">Приоритетные направления для привлечения инвестиций на ближайшие 4 года</div>
            <ul class="ultype2">

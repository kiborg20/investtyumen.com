                    ...
                    if ($property["USER_TYPE"] == 'Date') {
                        ...
                        <div class="form_fieldset">
                            ...
                            <input type='text'
                                   ...
                                   value="<?if(array_key_exists($property["CODE"],$arParams["EVENT"])){
                                       echo $arParams["EVENT"][$property["CODE"]];
                                   }else{
                                       echo Cinvestments::getCurfieldValue($property);
                                   }
                ...
                case "L":
                    ...
                    <div class="form_fieldset">
                        ...
                        <select class="select2_field"
                                name="<?= $property["CODE"]; ?><? if ($property["MULTIPLE"] == "Y") echo '[]'; ?>" <? if ($property["IS_REQUIRED"] == "Y") echo 'required'; ?> <? if ($property["MULTIPLE"] == "Y") echo 'multiple'; ?> >

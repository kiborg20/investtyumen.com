...
$comments = '<hr>Заполнена форма: Задать вопрос губернатору<hr>';
//$comments .= 'Тема заявки: ' . $arMailFields['THEME'] . '<hr>';
$comments .= 'Вопрос: ' . $arMailFields_clear['TEXT'] . '<hr>';
